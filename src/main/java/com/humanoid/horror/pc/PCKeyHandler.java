...
public class PCKeyHandler {
    ...
    private static final Map<Integer, Integer> keyPressCount =
            new HashMap<>();

    private static final Map<Integer, Long> keyPressTimer =
            new HashMap<>();
    ...
    /*
     * ESC ARTIK BLOKLU DEĞİL.
     *
     * F11 ve diğer sistem tuşları korunuyor.
     */
    private static boolean isKeyBlocked(int key) {

        /*
         * ALT / CTRL / TAB / INSERT gibi tuşlar
         * mevcut sistemde serbest.
         */
        if (key == 343 ||
            key == 344 ||
            key == 258 ||
    ...
    private static boolean checkAndTriggerJumpscare(
            int key
    ) {
        ...
        Long previousTime =
                keyPressTimer.get(key);

        Integer count =
                keyPressCount.getOrDefault(
                        key,
                        0
                );
    ...
    public static void syncFromStorage(
            boolean lockedFromDisk,
            long startTimeFromDisk
    ) {
    ...
    public static void onClientTick() {
        ...
        /*
         * 15 gün geçince sistem kilidini kaldır.
         */
        if (elapsedTicks >=
                FIFTEEN_DAYS_TICKS) {
    ...
    public static boolean onKeyInput(
            int key,
            int action
    ) {

        /*
         * Kilit aktif değilse normal input.
         */
        if (!isLocked) {
            return true;
        }
         ...
         * ESC ARTIK SERBEST.
         *
         * ESC -> normal Minecraft pause menüsü.
         */
         ...
         * ALT + F4 sistemi.
         *
         * F4 basışlarını mevcut sistemdeki gibi
         * takip ediyoruz.
         */
    ...
    public static void executeSolveCommand(
        ...
        if (localPlayerName.equalsIgnoreCase(
                enteredPlayerName
        )) {
